...
},_showSubmenu:function(f,a){a.css("z-index",++PUI.zindex);
if(f.parent().hasClass("pui-menu-child")){var e=$(window),g=f.offset(),h=g.top,b=a.outerHeight(),d=f.outerHeight(),c=(h+b)>(e.height()+e.scrollTop())?(-1*b)+d:0;
a.css({left:f.outerWidth(),top:c,"z-index":++PUI.zindex}).show()
}else{a.css({left:0,top:f.outerHeight()})
}a.show()
}})
});
